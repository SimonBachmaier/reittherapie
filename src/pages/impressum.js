...
//   const { frontmatter } = data.markdownRemark
  ...
  return (
    <Layout headerText="Impressum" hideImage={true}>
      <TextSection 
        headline=""
        subheadline=""
      >
        ...
        <p>Telefon: +09143/6518</p>
        <p>E-Mail: metroid999@gmx.de</p>
        ...
        <p>
        <span style={{textDecoration: 'underline'}}>Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:</span>
        </p>
        ...
        <p>
        <span style={{textDecoration: 'underline'}}>Haftungsbeschränkung für externe Links</span>
        </p>
        <p>
        <strong>&nbsp;</strong>
        </p>
        ...
        <em>Name Ihrer Domain</em>“ gesetzten Links und Verweise von Fragestellern, Blogeinträgern, Gästen des Diskussionsforums. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargestellten Informationen entstehen, haftet allein der Diensteanbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.
        </p>
        ...
        <p>Dieses <a href="http://www.jurarat.de/muster-impressum">Impressum</a> wurde freundlicherweise von www.jurarat.de zur Verfügung gestellt.
        </p>
