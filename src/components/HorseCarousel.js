    ...
    return (
        <Row className={props.className}>
            <Col md="4" className="pr-5">
                ...
                <p className="mb-5">Unsere Therapiepferde haben ein ausgeglichenes und ruhiges Wesen. Sie leben in einer kleinen Herde artgerecht und zufrieden in einem großen Offenstall und auf einer sehr großen Koppel.</p>
